...
$(document).on('click', '.book-btn', function () {
    ...
    if ($('#QUERY').val() == "") {
        ...
        window.location.href = "https://citrusholidays.travelflow.co.uk/directsearch.asp?bn=0004&SearchType=PACKAGE" + "&Depart=" + $('#depart').val() + "&Destination=" + $('#areacode').val() + "&OBDate=" + $('#obdate').val() + "&IBDate=" + $('#ibdate').val() + "&Adults=" + $('#passenger').val().replace(' adults', '') + "&Children=0" + "&hotel=" + $('#hotel_name').val();
    }
})
...
$(document).on('focus', '.datepicker-content-20', function () {
